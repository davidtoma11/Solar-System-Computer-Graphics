...
void RenderFunction(void)
{
	...
	// MERCUR
	matrTrans = glm::translate(glm::mat4(1.0f), glm::vec3(180.f, 2400.f, 0.f));
	...
	DrawShadow(myMatrix);
	// VENUS
	matrTrans = glm::mat4(1.0f) * glm::translate(glm::mat4(1.0f), glm::vec3(-100.0f, 100.0f, 0.0f));
	...
	DrawShadow(myMatrix);
	// PAMANT
	matrTrans = glm::mat4(1.0f) * glm::translate(glm::mat4(1.0f), glm::vec3(10.0f, -300.0f, 0.0f));
	...
	DrawShadow(myMatrix);
	// LUNA
	matrTrans = glm::mat4(1.0f) * glm::translate(glm::mat4(1.0f), glm::vec3(70.0f, -400.0f, 0.0f));
	...
	DrawPlanet(myMatrix);
	// MARTE
	matrTrans = glm::mat4(1.0f) * glm::translate(glm::mat4(1.0f), glm::vec3(200.0f, -700.0f, 0.0f));
	matrScale = glm::scale(glm::mat4(1.0f), glm::vec3(0.5f, 0.5f, 0.5f));
